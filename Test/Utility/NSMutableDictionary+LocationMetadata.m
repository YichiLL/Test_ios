//
//  NSMutableDictionary+LocationMetadata.m
//  TripGo
//
...
#import "NSMutableDictionary+LocationMetadata.h"

@implementation NSMutableDictionary (LocationMetadata)
...
- (void)setLocation:(CLLocation *)location {
    ...
    if (location) {
        ...
        [locDict setObject:[self getUTCFormattedDate:location.timestamp] forKey:(NSString*)kCGImagePropertyGPSDateStamp];
        [locDict setObject:[self getUTCFormattedTime:location.timestamp] forKey:(NSString*)kCGImagePropertyGPSTimeStamp];
